...
public class AngleGradientImageButton extends AppCompatImageButton {
    ...
    public AngleGradientImageButton(Context context) {
        super(context);
        init(context, null, 0);
    }

    public AngleGradientImageButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public AngleGradientImageButton(Context context, AttributeSet attrs, int defStyleAttr) {
